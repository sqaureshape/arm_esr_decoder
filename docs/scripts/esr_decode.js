...
function createFieldBreakdownRows(esr) {
  ...
  // Create the exact format from the reference - simple, clean table
  
  // RES0 field (bits 26-31) - 6 bits
  rows += `<tr>`;
  ...
  rows += `<tr>`;
  rows += `<td colspan="6" class="field-value">RES0: 0x${ec.toString(16).toUpperCase()}</td>`;
  rows += `<td colspan="26" class="field-value">RES0: 0x${iss.toString(16).toUpperCase()}</td>`;
  rows += `</tr>`;
  
  // ISS2 field (bits 20-24) - 5 bits
  rows += `<tr>`;
  ...
  rows += `<tr>`;
  rows += `<td colspan="12" class="field-value">ISS2: 0x${((iss >> 20) & 0x1F).toString(16).toUpperCase()} 0b${((iss >> 20) & 0x1F).toString(2).padStart(5, '0')}</td>`;
  rows += `<td colspan="20" class="field-value">ISS2: 0x${((iss >> 20) & 0x1F).toString(16).toUpperCase()} 0b${((iss >> 20) & 0x1F).toString(2).padStart(5, '0')}</td>`;
  rows += `</tr>`;
...
function addDetailedISSBreakdown(iss, ec) {
  ...
  if (ec === 0x1E) {
    ...
    rows += `<tr>`;
    rows += `<td colspan="7" class="field-value">RES0: 0x${((iss >> 25) & 0x7F).toString(16).toUpperCase()}</td>`;
    ...
    rows += `<tr>`;
    rows += `<td colspan="7" class="field-value">RES0: 0x${((iss >> 12) & 0x1FFF).toString(16).toUpperCase()}</td>`;
